...
public class JavaQuestionServiceTest {
    ...
    void getRandomQuestion_withEmptyCollection_whenDefaultQuestions() {
        ...
        Assertions.assertEquals("Вы видите этот вопрос?", q.getQuestion());
        Assertions.assertEquals("Значит преподаватель не успел заготовить вопросы", q.getAnswer());
    }
//на рандомность не тестирую, так как в сете изначально не гарантирован статичный порядок
    ...
    void getAnswer_withInvalidQuestion_whenDefaulAnswer() {
        ...
        Assertions.assertEquals("ответа у нас нет :(", actRes);
    }
